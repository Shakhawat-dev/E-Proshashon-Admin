...
import com.metacoders.e_proshashonadmin.Acitivity.AssaginedList.AssaginedListEmployee;
...
import com.metacoders.e_proshashonadmin.databinding.ActivityAssaignedListForAdminsBinding;
import com.metacoders.e_proshashonadmin.utils.SharedPrefManager;

import java.util.ArrayList;
import java.util.List;

public class AssaignedListForAdminsActivity extends AppCompatActivity implements complainListAdapter.ItemClickListener {
    ...
    private ActivityAssaignedListForAdminsBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAssaignedListForAdminsBinding.inflate(getLayoutInflater());
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    ...
                    try {
                        if (model.getAssignedBy().equals(uid)) {
                ...
                binding.clist.setAdapter(new complainListAdapter(complainModelList, getApplicationContext(), AssaignedListForAdminsActivity.this));
